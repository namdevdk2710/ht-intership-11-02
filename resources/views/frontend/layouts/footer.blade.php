<div class="section_footer_as clearfix">
    <div class="row copyright mg0">
        <div class="col-md-3 text-left">
            <div class="footer_logo">
                <a href="vn.html"><img class="img-responsive" src="{{asset('frontend/images/UploadImages/logo_grey.png')}}" /></a>
            </div>
        </div>
        <div class="col-md-3 text-left">
  ...
  Điện thoại: (84 24) 3540 1988</span></span>
        ...
        <div class="clearfix menu_footer text-center" style="padding-bottom:5px;width:100%;clear:both">
            <a href="vn/welcome/about-us.html">VỀ AMARIN</a> <span>|</span> <a href="vn/accommodation.html">PHÒNG</a> <span>|</span> <a href="vn/gallery.html">THƯ VIỆN</a> <span>|</span> <a href="vn/welcome/sitemap.html">SITEMAP</a> <span>|</span>
            <a href="vn/contact.html">LIÊN HỆ</a>
        </div>
